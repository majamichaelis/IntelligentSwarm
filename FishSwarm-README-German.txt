...
Das SwarmManager Prefab sollte in die Szene gesetzt werden. 
	...
	- Neighbour Distance: die Fische berechnen Rotation und Richtung anhand ihrer Nachbarn. Dieser Wert bestimmt welche Fische 
          aufgrund ihrer Distanz als Nachbarn in Frage kommen
	- Avoid Value: bestimmt wie viel Abstand die Fische zueinander einhalten 

! viele Werte beeinflussen sich gegenseitig. Außerdem wird das Jobs und Burst Package benötigt.
	:) 